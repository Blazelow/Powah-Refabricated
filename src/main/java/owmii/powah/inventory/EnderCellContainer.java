...
public class EnderCellContainer extends AbstractEnergyContainer<PowahBaseEnderBlockEntity<?>> {
    ...
    public EnderCellContainer(int id, Inventory inventory, PowahBaseEnderBlockEntity te) {

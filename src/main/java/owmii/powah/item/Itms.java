...
public class Itms {
    ...
    public static final DeferredItem<AerialPearlItem> PLAYER_AERIAL_PEARL = DR.register("player_aerial_pearl",
            () -> new AerialPearlItem(new Item.Properties()));
    public static final DeferredItem<PowahBaseItem> BLANK_CARD = DR.register("blank_card",
            () -> new PowahBaseItem(new Item.Properties()));
    ...
    public static final DeferredItem<PowahBaseItem> THERMOELECTRIC_PLATE = DR.register("thermoelectric_plate",
            () -> new PowahBaseItem(new Item.Properties()));
    public static final DeferredItem<PowahBaseItem> DIELECTRIC_PASTE = DR.register("dielectric_paste",
            () -> new PowahBaseItem(new Item.Properties()));
    public static final DeferredItem<PowahBaseItem> DIELECTRIC_ROD = DR.register("dielectric_rod",
            () -> new PowahBaseItem(new Item.Properties()));
    public static final DeferredItem<PowahBaseItem> DIELECTRIC_ROD_HORIZONTAL = DR.register("dielectric_rod_horizontal",
            () -> new PowahBaseItem(new Item.Properties()));
    public static final DeferredItem<PowahBaseItem> DIELECTRIC_CASING = DR.register("dielectric_casing",
            () -> new PowahBaseItem(new Item.Properties()));
    public static final DeferredItem<PowahBaseItem> ENERGIZED_STEEL = DR.register("steel_energized",
            () -> new PowahBaseItem(new Item.Properties()));
    public static final DeferredItem<PowahBaseItem> BLAZING_CRYSTAL = DR.register("crystal_blazing",
            () -> new PowahBaseItem(new Item.Properties()));
    public static final DeferredItem<PowahBaseItem> NIOTIC_CRYSTAL = DR.register("crystal_niotic",
            () -> new PowahBaseItem(new Item.Properties()));
    public static final DeferredItem<PowahBaseItem> SPIRITED_CRYSTAL = DR.register("crystal_spirited",
            () -> new PowahBaseItem(new Item.Properties()));
    public static final DeferredItem<PowahBaseItem> NITRO_CRYSTAL = DR.register("crystal_nitro",
            () -> new PowahBaseItem(new Item.Properties()));
    public static final DeferredItem<PowahBaseItem> ENDER_CORE = DR.register("ender_core",
            () -> new PowahBaseItem(new Item.Properties()));

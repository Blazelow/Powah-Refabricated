...
public class JeiEnergizingCategory extends AbstractCategory<RecipeHolder<EnergizingRecipe>> {
    public static final RecipeType<RecipeHolder<EnergizingRecipe>> TYPE = RecipeType.create("powah", "energizing", (Class<RecipeHolder<EnergizingRecipe>>) (Class<?>) RecipeHolder.class);

    public JeiEnergizingCategory(IGuiHelper guiHelper) {
        super(guiHelper, Blcks.ENERGIZING_ORB, Component.translatable("gui.powah.jei.category.energizing"),
    ...
    public static List<RecipeHolder<EnergizingRecipe>> getAllRecipes() {
        ...
        return recipeManager.getAllRecipesFor(Recipes.ENERGIZING);
    }
}

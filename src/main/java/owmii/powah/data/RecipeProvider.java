...
public class RecipeProvider extends net.minecraft.data.recipes.RecipeProvider {
    public RecipeProvider(net.fabricmc.fabric.api.datagen.v1.FabricDataOutput output, CompletableFuture<HolderLookup.Provider> registries) {
    ...
    private static void energizingRod(RecipeOutput output) {
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, Blcks.ENERGIZING_ROD.get(Tier.BASIC))
                ...
                .pattern("bcb")
                .pattern(" h ")
                .define('q', ITags.Items.QUARTZ_BLOCKS)
                .define('h', Blcks.ENERGIZING_ROD.get(Tier.STARTER))
                .define('b', Itms.CAPACITOR_BASIC)
                .define('c', Itms.DIELECTRIC_CASING)
                .unlockedBy("has_quartz_block", has(ITags.Items.QUARTZ_BLOCKS))
    ...
    private static void energizingOrb(RecipeOutput output) {
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, Blcks.ENERGIZING_ORB)
                ...
                .define('g', net.fabricmc.fabric.api.tag.convention.v2.ConventionalItemTags.GLASS_BLOCKS)
                .define('c', Itms.DIELECTRIC_CASING)
                .unlockedBy(getHasName(Itms.DIELECTRIC_ROD_HORIZONTAL), has(Itms.DIELECTRIC_ROD_HORIZONTAL))
                .unlockedBy("has_glass", has(net.fabricmc.fabric.api.tag.convention.v2.ConventionalItemTags.GLASS_BLOCKS))
                .unlockedBy(getHasName(Itms.DIELECTRIC_CASING), has(Itms.DIELECTRIC_CASING))
    ...
    private void energizingRecipes(RecipeOutput output) {
        ...
        output.accept(Powah.id("energizing/niotic_crystal"),
                new EnergizingRecipe(new ItemStack(Itms.NIOTIC_CRYSTAL), 300000, List.of(Ingredient.of(net.minecraft.tags.TagKey.create(net.minecraft.core.registries.Registries.ITEM, net.minecraft.resources.ResourceLocation.fromNamespaceAndPath("c", "gems/diamond"))))), null);
        ...
        output.accept(Powah.id("energizing/spirited_crystal"),
                new EnergizingRecipe(new ItemStack(Itms.SPIRITED_CRYSTAL), 1000000, List.of(Ingredient.of(net.minecraft.tags.TagKey.create(net.minecraft.core.registries.Registries.ITEM, net.minecraft.resources.ResourceLocation.fromNamespaceAndPath("c", "gems/emerald"))))), null);

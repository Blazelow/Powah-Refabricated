...
public class CableRenderer extends AbstractTileRenderer<CableBlockEntity> {
    ...
    public void render(CableBlockEntity te, final float pt, final PoseStack matrix, final MultiBufferSource rtb, final Minecraft mc, final ClientLevel world,

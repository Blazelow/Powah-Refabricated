...
public class ItemModelProperties {
    public static void register() {
        ItemProperties.register(Itms.BINDING_CARD, Powah.id("bound"), ItemModelProperties::renderBindingCard);
        ItemProperties.register(Itms.BINDING_CARD_DIM, Powah.id("bound"), ItemModelProperties::renderBindingCard);
    }
